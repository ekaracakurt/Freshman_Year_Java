import java.util.*;
public class TextDecryptionDeneme {
	...
	Scanner keyboard = new Scanner(System.in);
		...
		System.out.println("Please enter a 14 digit integer text encryption key: ");
		...
		int rem_select ;
		int count = 0;
		int decryptiontime = txtinp.length();
